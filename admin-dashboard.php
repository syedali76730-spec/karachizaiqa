...
<head>
    ...
    <style>
        ...
        * {
        ...
        .row-deleting {
            animation: rowFadeOut 0.45s ease forwards;
...
<body>
    ...
    <script>
        ...
        function renderOrdersTable(orders, containerId) {
            ...
            const deletable = ['picked_up', 'cancelled'];
                ...
                html += `
                    <tr id="order-row-${order.id}">
                        ...
                        <td>
                            ...
                            ${deletable.includes(order.status) ? `<button class="btn btn-sm btn-danger" onclick="deleteOrder(${order.id}, '${order.order_number}')">🗑️ Delete</button>` : ''}
                        </td>
                    </tr>
                `;
            });
